...
<Project Type="Project" LVVersion="9008000">
	<Property Name="NI.Project.Description" Type="Str">This project is a part of mobile agent system. It's designed to script visitor classes and a factory class for new programmed agents.

Action and interaction of agents in the mobile agent system  is realized using the visitor design pattern. the agent class provides public interface methods which are called by sending a visitor to the agent calling the public method in it's override action.vi. Visitors can transport parameters and return values in their attributes.
Factory is needed on the one hand for creation of initialized objects, on the other hand it allows to load all classes of a library in the memory at once having a default objects in its classes.vi.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="HGF_VisitorGenerator.lvlib" Type="Library" URL="../HGF_VisitorGenerator.lvlib"/>
